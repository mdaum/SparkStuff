...
public final class JavaRecCount {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length < 1) {
      System.err.println("Usage: JavaRecCount <file>");
      System.exit(1);
    }

    // Create a new Spark Context
    SparkConf conf = new SparkConf().setAppName("RecCount");
    ...
    System.setOut(new PrintStream(new FileOutputStream("reccounts")));
